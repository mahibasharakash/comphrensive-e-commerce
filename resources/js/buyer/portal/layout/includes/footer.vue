<template>
    ...
    <div class="fixed bottom-14 end-0 pe-5 pb-5">
        <button type="button" class="duration-500 cursor-pointer rounded-4xl max-w-40 min-w-40 min-h-12 max-h-12 bg-orange-600 hover:bg-orange-800 text-white flex justify-between items-center px-7 -rotate-90">
            <span> Back Top </span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="min-w-3.5 max-w-3.5 min-h-3.5 max-h-3.5 text-white">
