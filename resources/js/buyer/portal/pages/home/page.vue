        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-5">
            <div class="w-full min-h-72 max-h-72 bg-gray-100 flex justify-center items-center flex-col px-10 rounded-lg">
                <div class="w-full">
                    ...
                    <div class="mb-3 max-w-24 min-w-24 border"></div>
                    <div class="w-full block text-black">
                        <a href="javascript:void(0)" class="decoration-0 text-black text-md uppercase"> More Details </a>
                    </div>
                </div>
            </div>
            <div class="w-full min-h-72 max-h-72 bg-gray-100 flex justify-center items-center flex-col px-10 rounded-lg">
        ...
        <div class="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            <div class="w-full bg-transparent border border-gray-200 py-5 group relative">
                <div class="absolute top-0 end-0 p-5 duration-500 opacity-0 group-hover:opacity-100">
                    <button type="button" class="bg-transparent p-0 m-0 duration-500 cursor-pointer text-black focus-within:text-orange-700">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                        </svg>
                    </button>
                </div>
                <div class="max-h-64 min-h-64 w-full overflow-hidden">
                    <img :src="'/collection/image-1.jpg'" class="w-full max-h-64 min-h-64 object-contain bg-cover" alt="most-viewed-image" />
                </div>
                <div class="w-full px-5 pb-1 block text-xs"> Drone </div>
                <div class="w-full px-5 pb-1 block text-lg"> Drones Helicopter </div>
                <div class="w-full px-5 block text-end text-md"> $125 </div>
            </div>
            <div class="w-full bg-transparent border border-gray-200 py-5 group relative">
                <div class="absolute top-0 end-0 p-5 duration-500 opacity-0 group-hover:opacity-100">
                    <button type="button" class="bg-transparent p-0 m-0 duration-500 cursor-pointer text-black focus-within:text-orange-700">
                ...
                <div class="max-h-64 min-h-64 w-full overflow-hidden">
                    <img :src="'/collection/image-2.jpg'" class="w-full max-h-64 min-h-64 object-contain bg-cover" alt="most-viewed-image" />
                </div>
                <div class="w-full px-5 pb-1 block text-xs"> Drone </div>
                <div class="w-full px-5 pb-1 block text-lg"> Drones Helicopter </div>
                <div class="w-full px-5 block text-end text-md"> $125 </div>
            ...
            <div class="w-full bg-transparent border border-gray-200 py-5 group relative">
                ...
                <div class="max-h-64 min-h-64 w-full overflow-hidden">
                    <img :src="'/collection/image-3.jpg'" class="w-full max-h-64 min-h-64 object-contain bg-cover" alt="most-viewed-image" />
                </div>
                <div class="w-full px-5 pb-1 block text-xs"> Drone </div>
                <div class="w-full px-5 pb-1 block text-lg"> Drones Helicopter </div>
                <div class="w-full px-5 block text-end text-md"> $125 </div>
            ...
            <div class="w-full bg-transparent border border-gray-200 py-5 group relative">
                ...
                <div class="max-h-64 min-h-64 w-full overflow-hidden">
                    <img :src="'/collection/image-4.jpg'" class="w-full max-h-64 min-h-64 object-contain bg-cover" alt="most-viewed-image" />
                </div>
                <div class="w-full px-5 pb-1 block text-xs"> Drone </div>
                <div class="w-full px-5 pb-1 block text-lg"> Drones Helicopter </div>
                <div class="w-full px-5 block text-end text-md"> $125 </div>
    ...
    <section class="w-full bg-gray-100">
        <div class="w-full mx-auto max-w-7xl">
            <div class="w-full grid grid-cols-1 md:grid-cols-2 items-center">
                <div class="w-full">
                    <img :src="'/collection/image-5.png'" class="object-cover bg-cover w-full max-h-96 min-h-96" alt="view-collection-image" />
                </div>
                <div class="w-full py-10">
                    <div class="w-full text-3xl font-bold max-w-96 mb-5 leading-9"> We are the leading luxury watch retailer in UK </div>
                    <div class="w-full text-sm font-normal max-w-96 mb-5 leading-6">
                        Stocking the finest luxury watch brands, we specialise in sourcing new and used quality timepieces through our website
                    </div>
                    <a href="javascript:void(0)" class="inline-block text-white bg-black duration-500 hover:bg-black/65 px-7 py-3 rounded-md">
                        View Collections
                    </a>
