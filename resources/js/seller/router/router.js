...
import dashboard from "../portal/pages/dashboard/page.vue";

const routes = [
    { path: '/seller/auth', name: 'authenticationLayout', component: authenticationLayout,
        children: [
    ...
    { path: '/seller', name: 'portalLayout', component: portalLayout,
        children: [
